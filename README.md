...
- [Quickstart: Notebook in the Cloud](#quickstart-notebook-in-the-cloud)
- [Transformations](#transformations)
...
See the [SPMD MNIST classifier from scratch
...
- CUDA 11.1 or newer is _required_.
...
- You _must_ use an NVidia driver version that is at least as new as your
